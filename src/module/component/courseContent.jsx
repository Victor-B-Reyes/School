  ...
  return (
    ...
    <section aria-labelledby="certificacion-heading" className="px-4 py-10 sm:px-6 lg:py-16">
      <div className="mx-auto grid max-w-6xl overflow-hidden rounded-3xl border border-white/10 bg-gray-900/80 shadow-2xl md:grid-cols-2">
        ...
        <div
          className="flex items-center justify-center bg-black/20 p-5 sm:p-8"
          onContextMenu={(e) => e.preventDefault()}
        >
          <img
            src="/CertificadoIOT.png"
            alt="Ejemplo del certificado del curso"
            className="h-auto max-h-[28rem] w-full rounded-xl border border-white/10 object-contain shadow-lg select-none"
            draggable={false}
            onContextMenu={(e) => e.preventDefault()}
          />
        </div>
