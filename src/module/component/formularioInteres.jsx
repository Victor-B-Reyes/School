...
<b>📞 Contacto:</b> <code>${form.contacto}</code>`.trim());
    ...
    return (
        <section className="relative z-10 p-6">
            <h3 className="text-xl font-semibold text-white">Formulario de interes</h3>
            <p className="mt-2 text-sm text-gray-300">Completa tus datos para solicitar acceso al curso.</p>
            <form onSubmit={handleSubmit} className="relative mt-6 space-y-4">
                ...
                <div><label className="mb-2 block text-sm font-medium text-gray-200">Curso</label><input type="text" value={curso} disabled className="w-full rounded-lg border border-gray-600 bg-gray-800 px-4 py-3 text-gray-400" /></div>
