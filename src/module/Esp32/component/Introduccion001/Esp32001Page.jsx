...
import Esp32001P01Component from "./Esp32001_P01Component";
        ...
        <div className="w-full rounded-lg shadow-2xl bg-white p-5">
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="w-full md:w-5/6">
                    {page === 0 ?<div>
                        <h1 id="inicio" className="titulo-principal">Placa de desarrollo ESP32 DevKit V1</h1>
